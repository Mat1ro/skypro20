...
class TestMovieService:
    ...
    def test_delete(self):
        movie_removed = self.movie_service.delete(1)

        assert movie_removed is None

    def test_update(self):
        movie_d = {
            "title": 'Убийцы цветочной луны',
            "description": 'История разворачивается в 1920-х годах вокруг индейского племени осейдж, проживающего '
                           'в американском городе Оклахома. Коренных жителей США убивают одного за другим после того, '
                           'как один из них разбогател, обнаружив нефть. Массовые убийства осейджей привлекают '
                           'внимание ФБР, и оно приступает к расследованию.',
